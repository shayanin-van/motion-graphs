...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function Mu(){return new ri({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function Tu(){return new ri({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yc(),fragmentShader:`
